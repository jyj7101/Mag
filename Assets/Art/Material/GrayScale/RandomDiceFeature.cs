...
// 클래스 명 : 쉐이더 + 피쳐
public class RandomDiceFeature : ScriptableRendererFeature
{
    ...
    class RandomDicePass : ScriptableRenderPass
    {
        ...
        public RandomDicePass(string profilerTag)
        {
    ...
    private RandomDicePass scriptablePass;

    public override void Create()
    {
        scriptablePass = new RandomDicePass("RandomDice");
