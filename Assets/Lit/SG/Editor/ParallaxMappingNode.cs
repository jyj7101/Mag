...
{
    [Title("UV", "Parallax Mapping Advanced")]
    class ParallaxMappingNode : AbstractMaterialNode, IGeneratesBodyCode, IGeneratesFunction, IMayRequireViewDirection, IMayRequireMeshUV
    {
        ...
        {
            name = "Parallax Mapping Advanced";
        ...
        private const int kTextureSTSlotId = 5;
        private const string kTextureSTSlotName = "Texture_ST";
        ...
        public sealed override void UpdateNodeAfterDeserialization()
        {
            ...
            AddSlot(new Texture2DInputMaterialSlot(kTextureSTSlotId, kTextureSTSlotName, kTextureSTSlotName, ShaderStageCapability.Fragment));
        ...
        public void GenerateNodeCode(ShaderStringBuilder sb, GenerationMode generationMode)
        {
            ...
            var textureSTSlot = FindInputSlot<Texture2DInputMaterialSlot>(kTextureSTSlotId);
            ...
            sb.AppendLines(String.Format(@"$precision2 {5} = {0}.GetTransformedUV({4}) + ParallaxMapping(TEXTURE2D_ARGS({0}.tex, {1}.samplerstate), IN.{2}, {3}, {6}.GetTransformedUV({4}));",
                heightmap,
                ...
                edgesST.Any() ? GetSlotValue(kTextureSTSlotId, generationMode) : heightmap
            ));
        }
